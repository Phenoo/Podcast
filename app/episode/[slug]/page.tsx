...
import RelatedEpisodes from "../RelatedEpisodes";
import AudioPlayer from "@/app/episodes/AudioPlayer";
import { Platforms } from '@/app/components/elements/Platforms'; // Import the Platforms enum from the new file
...
const BlogPost = async ({ params: { slug } }: Props) => {
  ...
  const currentUrl = encodeURIComponent(
    process.env.SITE_URL + router.asPath
  );
    ...
    <>
      <ClientOnly>
        ...
        <div className="bg-gray">
          ...
          {/* Render the ShareLinks component */}
          <ShareLinks url={currentUrl} />
        </div>
      </ClientOnly>
    </>
  );
